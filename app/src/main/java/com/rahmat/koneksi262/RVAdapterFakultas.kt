...
class RVAdapterFakultas {
    ...
    class RVAdapterFakultas (private val context: Context, private val arrayList: ArrayList<Fakultas>) :
        RecyclerView.Adapter<com.rahmat.koneksi262.RVAdapterFakultas.Holder>(), Parcelable {
        ...
        companion object CREATOR : Parcelable.Creator<com.rahmat.koneksi262.RVAdapterFakultas> {
            override fun createFromParcel(parcel: Parcel): com.rahmat.koneksi262.RVAdapterFakultas {
                return com.rahmat.koneksi262.RVAdapterFakultas(parcel)
            }

            override fun newArray(size: Int): Array<com.rahmat.koneksi262.RVAdapterFakultas?> {
